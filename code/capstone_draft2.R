...
### Libraries ##################################################################
library(car, quietly=TRUE) # multicollinearity (VIF)
library(creditmodel, quietly=TRUE) # multicollinearity (Cramer's V)
library(ggplot2, quietly=TRUE)
library(MASS, quietly=TRUE) # stepwise selection
################################################################################

setwd("/Users/clarakim/Desktop/spring23/data_science_capstone_spring23")
all.waves <- read.csv("clean_wave12345_allvar.csv", header=TRUE)
