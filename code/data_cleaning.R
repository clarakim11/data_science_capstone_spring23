...
## Part 0: Clean survey data for each of the 5 waves
## Clara Kim '23
## Apr 26, 2023
################################################################################
...
## load original (unclean) data 
## [Note: this file is not included in this GitHub because it couldn't be shared publicly]
...
## subset data to only include survey participants who resopnded in all 5 waves
...
## write clean data into a .csv file
